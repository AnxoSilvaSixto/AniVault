...
<div class="media-grid">
	<div class="media-column prequels">
		<h4>Prequels</h4>
		<a href="Kara no Kyoukai Movie 4 Garan no Dou" class="internal-link">
			<img src="https://cdn.myanimelist.net/images/anime/9/21736.jpg" class="media-poster" alt="Broken link">
		</a>
		<p class="media-caption">Kara no Kyoukai Movie 4 Garan no Dou</p>
	</div>
	<div class="media-column sequels">
		<h4>Sequels</h4>
		<a href="Kara no Kyoukai Movie 6 Boukyaku Rokuon" class="internal-link">
			<img src="https://cdn.myanimelist.net/images/anime/2/21739.jpg" class="media-poster" alt="Broken link">
		</a>
		<p class="media-caption">Kara no Kyoukai Movie 6 Boukyaku Rokuon</p>
	</div>
</div>